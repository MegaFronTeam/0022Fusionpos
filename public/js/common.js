...
const JSCCommon = {
	...
	inputMask() {
		...
		let numberInput = [].slice.call(document.querySelectorAll('input.sms'));
		numberInput.forEach(element => element.setAttribute("pattern", "[0-9]{4}"));
		Inputmask("9 9 9 9").mask(numberInput);
	},
